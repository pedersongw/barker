      ...
      <div className={styles.wrapper}>
        ...
        <section>
          ...
          <p>
            ...
            agreement that most everything to make it a dog park would be
            provided by its patrons. R-DOG, Richmond Dog Owners’ Group, raised
            money for the fence and managed Barker Field for its first years.
            Friends of Barker Field organized in 2005 as a partner of Enrichmond
            Foundation.
          </p>
        </section>
        <section>

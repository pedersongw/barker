...
import image1 from "../../ParkImages/barkerimage.jpeg";
import image2 from "../../ParkImages/barker1.jpeg";
import image3 from "../../ParkImages/barker2.jpeg";
import image4 from "../../ParkImages/barker3.jpeg";
import image5 from "../../ParkImages/barker4.jpeg";
    ...
    return (
      <div className={styles.wrapper}>
        ...
        <section
          ...
          id={this.state.width < 800 ? styles.mobileRulesSection : null}
        >
          <div className={styles.desc}>
            <h2 className={styles["h2"]}>Rules for Barker Field</h2>
            <ul>
              <li className={styles.li}>
                The City of Richmond and Friends of Barker Field dog park are
                not responsible or liable for any injury to your person, dog,
              ...
              <li className={styles.li}>
                All persons entering the part are responsible for the animals
                they bring in. Please closely supervise your dog as you will be
                held liable for any damages caused by your dog to person, pets,
                and property.
              </li>
              <li className={styles.li}>
              ...
              <li className={styles.li}>
                All dogs must be leashed when not in the confines of the dog
                park. Richmond City Ordinance Section 4-243.
              </li>
              <li className={styles.li}>
                Dogs must be accompanied by an owner or caretaker. Any animal
                left on the premises without supervision will be considered
                abandoned and impounded at the Richmond City Animal Shelter.
              </li>
              <li className={styles.li}>
                Please clean up after your dog and yourself. Place all waste and
                litter in the proper receptacles. Let's keep the dog park safe
                and clean for all to enjoy. Richmond City Ordinance Section 4-90
              ...
              <li className={styles.li}>
                ...
                many reasons may not be a safe place for small children. The
                city is not responsible for any injury sustained to children
                while they are in the dog park.
              </li>
              <li className={styles.li}>
                Richmond Animal Care and Control (RACC), Richmond Police
                Department (RPD), and Richmond City Parks and Recreation
                Department has the right to ask any and/or all park goers to
                leave at any time.
              </li>
              <li className={styles.li}>
          ...
          {this.state.width > 800 && (
            <React.Fragment>
              <div className={styles.rulesImageDiv} id={styles.imageDivOne}>
                <img
              ...
              <div id={styles.imageDivTwo} className={styles.rulesImageDiv}>
                <img
                  className={styles.rulesImage}
                  alt="dogs"
                  src={image4}
